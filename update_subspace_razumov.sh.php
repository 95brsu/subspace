...
#   cd $HOME/subspace
#   docker build -t subspacelabs/subspace-node:snapshot-2022-may-19 -f $HOME/subspace/Dockerfile-node .
# }
#
# function build_image_farmer {
#   cd $HOME/subspace
#   docker build -t subspacelabs/subspace-farmer:snapshot-2022-may-19 -f $HOME/subspace/Dockerfile-farmer .
# }
...
function eof_docker_compose {
  ...
  services:
    node:
      image: ghcr.io/subspace/node:snapshot-2022-may-19
      networks:
        - default
        - subspace
      volumes:
